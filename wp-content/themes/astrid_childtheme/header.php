...
})(window,document,'script','dataLayer','GTM-WQ9SMGB');</script>
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQ9SMGB"
...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header <?php echo astrid_has_header(); ?>" role="banner">
		<div class="container">
			...
			<div class="btn-menu col-md-8 col-sm-4 col-xs-4"><i class="fa fa-navicon"></i></div>
